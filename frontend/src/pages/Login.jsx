  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      <div className="bg-white shadow-lg rounded-xl p-8 w-full max-w-md border border-gray-100">
        <h2 className="text-3xl font-bold mb-2 text-center text-gray-900">Login</h2>
        <p className="text-gray-600 text-sm text-center mb-6">Welcome back! Please sign in to your account.</p>
        ...
        <p className="text-sm text-center mt-6 text-gray-600">
          ...
          <Link to="/register" className="text-indigo-600 hover:text-indigo-700 font-medium underline-offset-2 hover:underline transition-colors">
            Register
          </Link>
        </p>
      </div>
